...
def handle_request(request_sender_socket: socket.socket, waiting_players: dict):
    """
    :param request_sender_socket: The socket of the player who send the request.
    :param waiting_players: List of players who waiting for opponent.
    :return: A list with new messages should be send to clients.
    """
...
def main():
    ...
    while True:
        ...
        # send all messages to clients listinning to server.
